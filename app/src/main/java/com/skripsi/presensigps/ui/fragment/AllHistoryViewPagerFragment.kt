...
class AllHistoryViewPagerFragment : Fragment() {
    ...
    private val context = "all_history"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_history_view_pager, container, false)
    }
